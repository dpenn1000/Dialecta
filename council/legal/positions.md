...
| **The exposure is the capability matrix, not the ladder.** Eight of the ten paid rows in `_subscription-tier.js` are inert until the Growth Layer ships. A pricing page that renders them as what the money buys is the misrepresentation A.R.S. 44-1522(A) names, and the code comment saying "scaffolding" is not a disclosure | Medium-high | `_recovered/api/_subscription-tier.js`, `docs/SUBSCRIPTION-MODEL.md`, `research/2026-az-consumer-fraud-act-44-1521.md` | 2026-09-20 |
