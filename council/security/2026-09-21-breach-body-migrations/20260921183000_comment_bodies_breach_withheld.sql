-- DRAFT, not applied. Written by the security seat under council/security/, per security.md ("you
-- report, you do not patch"). The convener copies this into supabase/migrations/ with a fresh
-- `supabase migration new comment_bodies_breach_withheld` timestamp at the time it is actually
-- applied, replacing the placeholder 20260921183000 above. Safe to apply on its own: it only adds a
-- function, and touches no existing grant.
--
