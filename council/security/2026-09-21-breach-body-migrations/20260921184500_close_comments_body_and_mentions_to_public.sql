-- DRAFT, not applied. Written by the security seat under council/security/. The convener copies
-- this into supabase/migrations/ with a fresh `supabase migration new
-- close_comments_body_and_mentions_to_public` timestamp at the time it is actually applied.
--
