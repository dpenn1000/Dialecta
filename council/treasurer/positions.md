...
| **If the Pennington Media Group organisation is on the Free tier, Dialecta's database is currently paused**, because Supabase pauses Free projects after a week of inactivity and Dialecta has been dormant since early May. That would undercut the assumption behind P0-2 through P0-7 | Medium, unverified | `research/2026-personal-web-properties-memory.md`, `research/2026-supabase-pricing.md` | 2026-09-20 |
