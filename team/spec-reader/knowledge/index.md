...
| `2026-dialecta-delta-mechanic-spec.md` | `docs/Dialecta_Delta_Mechanic_Spec.md` v1.0, cross-checked against Discourse Layer UX, Article Editorial Template, `CLAUDE.md`, backlog A-3 | Closes the last seed lead. Confirms the spec is not a comment-side Stage 2.5 and is a fourth document that cites one without defining it. `drift-map.md` I4 |
