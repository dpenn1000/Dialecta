...
| `Dialecta_Classification_Engine_Specification.md` | Canonical | Defines the AI prompt, tier boundary logic, and community reclassification architecture. The Discourse Layer UX consumes this spec. |
| `Dialecta_Tier_Psychology.md` | Canonical | Defines the naming rationale and commenter-message tone standard. The tier descriptions used in the nomination picker were drawn from this document. |
