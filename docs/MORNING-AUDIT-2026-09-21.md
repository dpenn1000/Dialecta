...
| **2.14** | **Seeded personas appear as real contributors.** Members seeded for the demo show on Community and in the feed with nothing marking them as examples. Retire them or label them | Community, the feed | Your call, then a small build |
