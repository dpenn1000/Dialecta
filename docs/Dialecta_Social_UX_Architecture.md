...
Not the full comment section -- a single highlighted exchange. Two or three comments forming a genuine back-and-forth, both Forum-rated, where something interesting happened: a position got refined, a counterargument got acknowledged, a steelman was offered and accepted. The feed card shows the exchange with tier badges visible, a line from the article for context, and a "join this thread" entry point.
...
Specific events worth surfacing:

- **Archetype shift** for a Correspondent or Sparring Partner. "Maria has shifted from Synthesizer toward Challenger across her last 20 comments." This tells you something real happened to how she's engaging and gives you a reason to visit her profile.
...
This makes them resistant to gaming in a way that follower counts and endorsements never are. When someone's Fingerprint shows high Charity and high Calibration, you learn something real about them.
...
**The Fingerprint reveal.** When a Fingerprint has an interesting shape -- very high Specificity but low Range, meaning someone goes deep on one topic but does not venture outside it -- that is a self-discovery moment people share. "Apparently I'm a depth-diver with an underdeveloped Charity axis" is the kind of thing that gets screenshotted.
...
*Companion documents: Dialecta_Project_Brief.md, Dialecta_Contributor_Identity.md, Dialecta_Growth_Layer_Principles.md*
